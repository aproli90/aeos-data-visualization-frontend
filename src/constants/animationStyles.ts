export const ANIMATION_STYLES = {
  line: {
    ...
    elastic: { type: 'linear', easing: 'elasticOut', duration: 2500, delay: 200, name: 'Elastic Stretch' },
    wave: { type: 'linear', easing: 'cubicInOut', duration: 2000, delay: 300, name: 'Wave Motion' },
  ...
  pie: {
    ...
    fanIn: { type: 'scale', easing: 'cubicInOut', duration: 1200, delay: 100, startAngle: 90, clockwise: true, name: 'Fan In' },
    rotate: { type: 'scale', easing: 'cubicInOut', duration: 1500, delay: 100, rotate: 720, clockwise: false, name: 'Rotate' },
    expand: { type: 'expansion', easing: 'bounceOut', duration: 1500, delay: 150, name: 'Expand' }
  },
  donut: {
    popOut: { type: 'scale', easing: 'elasticOut', duration: 1500, delay: 150, centerPop: true, name: 'Pop Out' },
    fanIn: { type: 'scale', easing: 'cubicInOut', duration: 1200, delay: 100, startAngle: 90, clockwise: true, name: 'Fan In' },
